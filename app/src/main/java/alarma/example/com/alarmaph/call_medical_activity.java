...
public class call_medical_activity  extends AppCompatActivity implements
        NavigationView.OnNavigationItemSelectedListener, View.OnClickListener{

    Button forecast;
    ListView medicalcall;
    //   TextView follow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_call_medical_activity);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("hotlines/medical");
        ...
        mDatabase.addChildEventListener(new ChildEventListener(){
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                call_medicallist adapter = new call_medicallist(call_medical_activity.this, a_agency, a_image);
                medicalcall = (ListView) findViewById(R.id.list_call_medical);
                medicalcall.setAdapter(adapter);

                medicalcall.setOnItemClickListener(new AdapterView.OnItemClickListener() {

                    @Override
                    public void onItemClick(AdapterView<?> parent, View view,
                                            int position, long id) {
                        //Toast.makeText(call_medical_activity.this,""+a_agency[+position], Toast.LENGTH_SHORT).show();
